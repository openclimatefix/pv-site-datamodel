...
class GenerationValuesSchema(pa.SchemaModel):
    ...
    start_utc: pa.typing.Series[pd.DatetimeTZDtype] = pa.Field(
        ...
        description="The start of the time period over which the generation value is valid."
    )
    power_kw: pa.typing.Series[pa.dtypes.Float] = pa.Field(
        ge=0,
        description="The power generated by the site in kw over the given time period."
    )
    site_uuid: pa.typing.Series[UUIDV4] = pa.Field(
        description="The UUID of the site to which the generation value refers."
    )
