...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "location_type",
            sa.Enum("site", "region", name="location_type"),
            server_default="site",
            nullable=False,
        ),
    )
    ...
    op.alter_column(
        "location_group_locations", "site_group_uuid", new_column_name="location_group_uuid"
    )
    op.alter_column(
        "location_group_locations",
        "site_group_site_uuid",
        new_column_name="location_group_location_uuid",
    )
    ...
    op.alter_column(
        "locations_history", "site_history_uuid", new_column_name="location_history_uuid"
    )
    ...
    op.alter_column("locations", "active", comment="Indicates if location is active")
    op.alter_column(
        "locations",
        "client_uuid",
    ...
    op.alter_column(
        "locations", "ml_model_uuid", comment="The ML Model which should be used for this location"
    )
    op.alter_column(
        "locations",
        "location_metadata",
...
def downgrade() -> None:
    ...
    op.alter_column(
        "location_group_locations", "location_group_uuid", new_column_name="site_group_uuid"
    )
    op.alter_column(
        "location_group_locations",
        "location_group_location_uuid",
        new_column_name="site_group_site_uuid",
    )
    ...
    op.alter_column(
        "locations_history", "location_history_uuid", new_column_name="site_history_uuid"
    )
