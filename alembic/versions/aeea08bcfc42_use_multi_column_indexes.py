...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_forecast_values_horizon_minutes", "forecast_values", ["horizon_minutes"], unique=False
    )
    op.create_index(
        "ix_forecast_values_forecast_uuid", "forecast_values", ["forecast_uuid"], unique=False
    )
    # ### end Alembic commands ###
