...
-- Database: PostgreSQL
-- Generated at: 2023-01-20T13:25:22.982Z
...
COMMENT ON TABLE "sites" IS 'Each site row specifies a single panel or cluster of panels
...
COMMENT ON COLUMN "sites"."client_uuid" IS 'The pvsite-datamodel ID of the client providing the site data';
