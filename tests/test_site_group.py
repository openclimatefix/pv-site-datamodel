...
def test_select_site_by_uuid(mocker):
    ...
    from pvsite_datamodel.site_group import select_site_by_uuid

    site_uuid = select_site_by_uuid(mock_session, "123e4567-e89b-12d3-a456-426614174000")
...
def test_select_site_by_uuid_not_found(mocker):
    ...
    with pytest.raises(ValueError, match="Site with UUID 123e4567-e89b-12d3-a456-426614174000 not found"):
...
def test_select_site_by_client_id(mocker):
    ...
    from pvsite_datamodel.site_group import select_site_by_client_id
...
def test_get_all_site_uuids(mocker):
    ...
    mock_session = Mock()
    mock_uuids = ["123e4567-e89b-12d3-a456-426614174000", "223e4567-e89b-12d3-a456-426614174000"]
    mocker.patch(
        "pvsite_datamodel.read.site.get_all_site_uuids",
        return_value=mock_uuids,
    )

    from pvsite_datamodel.site_group import get_all_site_uuids
...
def test_get_all_client_site_ids(mocker):
    ...
    from pvsite_datamodel.site_group import get_all_client_site_ids
...
def test_add_all_sites_to_site_group(mocker):
    ...
    assert sites_added == ["123e4567-e89b-12d3-a456-426614174000", "223e4567-e89b-12d3-a456-426614174000"]
...
def test_add_all_sites_to_site_group_no_new_sites(mocker):
    ...
    mock_session = Mock()
    mock_site_group = Mock()
    mock_site_group.locations = [Mock(location_uuid="123e4567-e89b-12d3-a456-426614174000")]
    mocker.patch(
        "pvsite_datamodel.site_group.get_site_group_by_name",
        return_value=mock_site_group,
    )
...
def test_change_user_site_group(mocker):
    ...
    from pvsite_datamodel.site_group import change_user_site_group

    user_email, user_site_group = change_user_site_group(mock_session, "test@example.com", "new_site_group")
